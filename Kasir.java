...
public class Kasir {
    ...
    public void tampilkanDaftarMeja() {
        ...
        for (int i = 0; i < daftarMeja.length; i++) {
            ...
            if (meja.getPelanggan() == null) {
                ...
                System.out.println("Meja " + (i + 1) + " (terisi oleh pelanggan " + meja.getPelanggan().getNama() + ")");
            }
        }
    }
    ...
    public void tambahPelanggan(int nomorMeja, Pelanggan pelanggan) {
        ...
        if (meja.getPelanggan() == null) {
            ...
            System.out.println("Pelanggan " + pelanggan.getNama() + " telah ditambahkan pada meja " + nomorMeja);
        } else {
            System.out.println("Meja sudah terisi oleh pelanggan");
        }
    }
    ...
    public void tambahPesanan(int nomorMeja, Menu menu) {
        ...
        if (meja.getPelanggan() != null) {
            meja.setMenu(menu);
            System.out.println("Menu " + menu.getNama() + " telah ditambahkan pada meja " + nomorMeja);
        } else {
    ...
    public void hapusPelanggan(int nomorMeja) {
        if (nomorMeja >= 1 && nomorMeja <= daftarMeja.length) {
            Meja meja = daftarMeja[nomorMeja - 1];
            if (meja.getPelanggan() != null) {
                System.out.println("Pelanggan " + meja.getPelanggan().getNama() + " di meja " + nomorMeja + " telah dihapus");
                meja.setPelanggan(null);
            } else {
                System.out.println("Meja " + nomorMeja + " tidak memiliki pelanggan");
            }
        } else {
        ...
        while (pilihan != 0) {
            ...
            switch (pilihan) {
                ...
                case 2:
                    ...
                    tambahPelanggan(nomorMejaTambahPelanggan, new Pelanggan(namaPelanggan));
                break;
                case 3:
